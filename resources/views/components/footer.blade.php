<footer class="px-4 pb-10 mt-24 overflow-hidden md:max-w-7xl md:mx-auto">
    <section>
        <div class="grid grid-cols-2">
            <div class="space-y-4 xl:col-span-1 col-span-full animate__animated animate__fadeInRight"
                x-animate.intersect="fadeInRight" style="--animate-duration: 1s;">
                <img class="w-[200px]" loading="lazy" src="/logo.png"
                    alt="Logo de Digiton">
            ...
            <div
                ...
                <a href="mailto:contact@digiton.ma"
                    class="flex items-center gap-3 px-6 py-3 duration-500 shadow-lg bg-primary-gradient rounded-3xl hover:scale-105 animate__animated animate__fadeInLeft"
                    x-animate.intersect="fadeInLeft" style="--animate-duration: 1s;">
                    <img class="w-[40px]" loading="lazy" src="https://digiton.ma/assets/images/mail.png"
                        alt="Icon d'email">
                    <div>
                        <p class="text-lg font-bold text-white ">Envoyez-nous un email</p>
                        <p class="text-white">contact@digiton.ma</p>
                    </div>

                </a>
                <a href="tel:+212606622329"
                    class="flex items-center gap-3 px-6 py-3 duration-500 bg-white shadow-lg rounded-3xl hover:scale-105 animate__animated animate__fadeInLeft"
                    x-animate.intersect="fadeInLeft" style="--animate-duration: 1s;">
                    <img class="w-[40px]" loading="lazy" src="https://digiton.ma/assets/images/phone.png"
    ...
    <section class="flex flex-col gap-16 mb-8 lg:flex-row lg:justify-between">
        <div class="flex justify-around order-2 gap-10 xl:order-1">
            ...
            <div class="flex flex-col">
                ...
                <ul class="space-y-5">
                    <li class="text-slate-500 hover:text-accent-green">
                        <a href="https://digiton.ma/formation-en-marketing-digital">Formation</a>
                    </li>
        ...
        <div wire:snapshot="{&quot;data&quot;:{&quot;email&quot;:&quot;&quot;,&quot;emailSent&quot;:false},&quot;memo&quot;:{&quot;id&quot;:&quot;ptCxoWhA4gIjpR6RyYXD&quot;,&quot;name&quot;:&quot;newsletterform&quot;,&quot;path&quot;:&quot;\/&quot;,&quot;method&quot;:&quot;GET&quot;,&quot;children&quot;:[],&quot;scripts&quot;:[],&quot;assets&quot;:[],&quot;errors&quot;:[],&quot;locale&quot;:&quot;fr&quot;},&quot;checksum&quot;:&quot;08ee3f64ee998de054cf5161a9d8f2cb9997a8eab9ef9a4f33630da459baebe1&quot;}"
            wire:effects="[]" wire:id="ptCxoWhA4gIjpR6RyYXD"
            class="w-full max-w-lg bg-overlay-dark px-8 py-16 xl:ml-36 rounded-3xl relative overflow-hidden order-1 xl:order-2 md:flex md:justify-center">


            <div class="w-40 aspect-square rounded-full bg-primary-gradient absolute z-0 -bottom-10 -left-10 animate__animated animate__zoomIn"
                x-animate.intersect="zoomIn" style="--animate-duration: 1s;">
            </div>

            <div class="w-40 aspect-square rounded-full bg-primary-gradient w-36 md:w-80 absolute z-0 -top-16 -right-16 md:-top-28 md:-right-28 animate__animated animate__zoomIn"
                x-animate.intersect="zoomIn" style="--animate-duration: 1s;">
            </div>

            <div class="w-full relative z-20 space-y-6"
                x-data="{ emailSent: window.Livewire.find('ptCxoWhA4gIjpR6RyYXD').entangle('emailSent').live }"
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="newsletter_email" name="newsletter_email" placeholder="Email"
                            class="w-full rounded-lg border-gray-200 p-4 text-sm  rounded-xl" wire:model="email"
                            label-class="sr-only">
                    ...
                    <button
                        class="flex items-center justify-center gap-2 text-accent-green bg-white px-6 py-3 rounded-xl font-semibold hover:bg-accent-green hover:bg-transparent border hover:border-white hover:text-white"
                        wire:click="subscribe" label="S'abonner">

                        <svg wire:loading="" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path wire:loading.class="animate-rotate"
                                d="M3 12a9 9 0 0 0 9 9a9 9 0 0 0 9 -9a9 9 0 0 0 -9 -9"></path>
